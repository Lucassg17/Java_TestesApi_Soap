...
public class ArquivoTxt {
    ...
    public static void escreverTexto(String linha, String titulo, String valor, PrintWriter gravarArq){
        ...
        gravarArq.printf(Geral.removerAcentos(valor.toLowerCase()) + "%n");
    }

    public static void escreverTextoPadraoDaTabela(String linha, String titulo, String valor, PrintWriter gravarArq){
        gravarArq.printf(titulo + "_" + linha + ": ");
        gravarArq.printf(Geral.removerAcentos(valor + "%n"));
    }
